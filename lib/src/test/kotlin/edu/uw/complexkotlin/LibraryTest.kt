...
class LibraryTest {
    ...
    // Philosopher Enum Tests
    @Test fun philosopherTests() {
        var seneca = Philosopher.THINKING
        assertEquals("Deep thoughts....", seneca.toString())  // Four dots
    ...
    @Test fun commandTests() {
        assertEquals("", Command("")(""))  // Empty prompt and message
        assertEquals("> Hello!", Command("> ")("Hello!"))  // Custom prompt and message
    }
}
